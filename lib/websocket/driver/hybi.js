...
var instance = {
  ...
  binary: function(message, isFragment, isEnd) {
    if (this.readyState > 1) return false;
    return this.frame(message, 'binary', undefined, isFragment, isEnd);
  },
  ...
  frame: function(buffer, type, code, isFragment, isEnd) {
    ...
    message.isFragment = isFragment;
    message.isEnd = isEnd;

    var onMessageReady = function(message) {
      var frame = new Frame();

      frame.final   = message.isFragment && !message.isEnd ? false : true;
      frame.rsv1    = this._firstFragment && message.rsv1;
      frame.rsv2    = message.rsv2;
      frame.rsv3    = message.rsv3;
      frame.opcode  = !message.isFragment || this._firstFragment ? message.opcode : this.OPCODES.continuation;
      frame.masked  = !!this._masking;
      frame.length  = message.data.length;
      frame.payload = message.data;

      if(message.isFragment && !message.isEnd){
